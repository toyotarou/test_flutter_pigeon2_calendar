...
interface CalendarApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: CalendarApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pigeon_calendar_sample.CalendarApi.getPlatformVersion$separatedMessageChannelSuffix", codec)
        if (api != null) {
